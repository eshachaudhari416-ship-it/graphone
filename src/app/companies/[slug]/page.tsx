...
import { openAIDetail } from "../../data/mockData";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          ...
          <section>
            ...
            <button className="text-[#FF3B5C] text-sm mt-3 hover:underline">
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <button className="text-[#FF3B5C] text-sm hover:underline self-center">
              View all leadership →
            </button>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            {company.products.map((product) => (
              <div key={product.name} className="flex flex-col items-center text-center p-3 bg-gray-50 rounded-xl hover:shadow-md transition-shadow cursor-pointer">
                <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center text-xl mb-2">
                  {product.emoji}
                </div>
